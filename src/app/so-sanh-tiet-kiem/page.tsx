  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "So sánh lãi suất tiết kiệm", item: `https://phantram.online${URL_PATH}` },
      ],
    },
    {
      "@type": "FAQPage",
        ...
        <main className="max-w-7xl mx-auto px-4 lg:px-6 py-8 space-y-12">
          ...
          <section>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {[
                { title: "Lãi kép là gì — hiệu ứng tuyết lăn", url: "https://blog.phantram.online/lai-kep-la-gi/", icon: "❄️" },
                { title: "Quy tắc 72 — bao lâu thì gấp đôi tiền?", url: "https://blog.phantram.online/quy-tac-72/", icon: "⏱️" },
